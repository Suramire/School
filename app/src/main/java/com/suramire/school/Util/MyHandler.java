    ...
    public void handleMessage(Message msg) {
        switch (msg.what){
            ...
            case MYHANDLER_DOWNLOAD:{
                ...
                builder.setTitle("请选中要下载的财大通联系人").setIcon(R.mipmap.ic_launcher);
                if(children.size() <= 0){
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if(mchildren.size()<=0){}else{
                                try{
                                    ...
                                    Toast.makeText(context, "下载联系人信息失败"+e, Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    });
            ...
            case MYHANDLER_UPLOAD:
                ...
                if (mchildren.size() != 0) {
                    ...
                    final AlertDialog.Builder builder  = new AlertDialog.Builder(context);
                    builder.setTitle("请选中要上传的本地联系人").setIcon(R.mipmap.ic_launcher);
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if(m2children.size()<=0){}else {
                                    try {
                                        ...
                                        Toast.makeText(context, "未读取到本机的联系人信息,请重试"+e, Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                        });
            ...
            case MYHANDLER_SINGLEDOWNLOAD:
                ...
                try {
                    ...
                    Toast.makeText(context, "下载联系人信息失败 错误:"+e, Toast.LENGTH_SHORT).show();
                }break;
            //单个删除联系人
            case  MYHANDLER_SINGLEDELETE:
                ...
                builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        }catch (Exception e){Toast.makeText(context, "删除失败 错误:"+e, Toast.LENGTH_SHORT).show();}
